...
The current semantic manifest records 17 TMDL-style tables, 59 measures, 9 relationships, and 11 dashboard page specifications. The physical PBIX currently contains 7 report pages.
