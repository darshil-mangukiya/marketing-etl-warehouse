...
`mart_funnel_performance[conversions]` is restricted to distinct converted leads from the SQL-qualified cohort at the same lead-created month and channel grain.
